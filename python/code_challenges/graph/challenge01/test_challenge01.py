...
def test_graph_breadth_first_traversal():
    ...
    actual = [1, 2, 3, 4]
    expected = g.breadth_first_traversal(node1)
...
def test2_graph_breadth_first_traversal():
    ...
    g.add_edge(node3, node4)
    actual = [3, 1, 2, 4]
    expected = g.breadth_first_traversal(node3)
    assert actual == expected
...
def test3_graph_breadth_first_traversal():
    ...
    actual = g.breadth_first_traversal(node_c)
    expected = ["c", "a", "b", "d", "e", "f", "g"]
    assert actual == expected

def test4_graph_breadth_first_traversal():
    g = Graph()
    node_a = g.add_node("a")
    node_b = g.add_node("b")
    node_c = g.add_node("c")
    ...
    g.add_edge(node_e, node_f)
    g.add_edge(node_f, node_g)
    actual = g.breadth_first_traversal(node_g)
